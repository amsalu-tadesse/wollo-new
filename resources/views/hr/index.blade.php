                                                        ...
                                                        <form>
                                                            ...
                                                            <div class="form-group  ">
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    name="employee_situation"class="form-control "
                                                                    id="employee_situation" readonly>

                                                            </div>
                                                            <div class="form-group  ">
                                                                <label for="MoreRoles">ተጨማሪ የስራ ድርሻ
                                                                </label>
                                                            ...
                                                            <div class="form-group ">
                                                                <label for="UniversityHiringEra"> የሰራተኛው አዎንታዊ ድጋፍ ተጠቃሚነት
