    ...
    <div class="container">
        ...
        <section class="hk-sec-wrapper mt-100">
            <div class="pull-right hk-sec-title">
                ...
                <a href="{{ route('educationlevel.create') }}" class="mr-25" data-toggle="tooltip" data-original-title="add">
                                ...
                                <tbody>
                                    @foreach ($admins as $i => $admin)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('educationlevel.destroy', $admin->id) }}"
                                                    method="POST">
                                                    ...
                                                    <a href="{{ route('educationlevel.edit', $admin->id) }}"
