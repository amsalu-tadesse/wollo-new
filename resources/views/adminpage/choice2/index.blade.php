    ...
    <div class="container">
        ...
        <section class="hk-sec-wrapper mt-100">
            <div class="pull-right hk-sec-title">
                ...
                <a href="{{ route('choice2.create') }}" class="mr-25" data-toggle="tooltip" data-original-title="add">
                                ...
                                <tbody>
                                    @foreach ($admins as $i => $admin)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('choice2.destroy', $admin->id) }}" method="POST">
                                                    ...
                                                    <a href="{{ route('choice2.edit', $admin->id) }}" data-toggle="tooltip"
