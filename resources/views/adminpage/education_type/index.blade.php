    ...
    <div class="container">
        ...
        <section class="hk-sec-wrapper mt-100">
            <div class="pull-right hk-sec-title">
                ...
                <a href="{{ route('educationtype.create') }}" class="mr-25" data-toggle="tooltip" data-original-title="add">
                                ...
                                <tbody>
                                    @foreach ($admins as $i => $admin)
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('educationtype.destroy', $admin->id) }}"
                                                    method="POST">
                                                    ...
                                                    <a href="{{ route('educationtype.edit', $admin->id) }}"
